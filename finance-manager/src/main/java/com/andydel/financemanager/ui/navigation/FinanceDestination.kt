...
sealed class FinanceDestination(val route: String) {
    ...
    data object AddTransaction : FinanceDestination("addTransaction?accountId={accountId}&transactionId={transactionId}")
    ...
    companion object {
        ...
        fun addTransactionRoute(accountId: Long? = null, transactionId: Long? = null): String {
            val accountSegment = accountId ?: -1L
            val transactionSegment = transactionId ?: -1L
            return "addTransaction?accountId=$accountSegment&transactionId=$transactionSegment"
        }
